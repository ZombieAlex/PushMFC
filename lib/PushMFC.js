...
var PushMFC = (function () {
    ...
    PushMFC.prototype.modelStatePusher = function (model, before, after) {
        if (before !== after) {
            var change;
            if (model._push.events[1 /* OnOff */] !== undefined || model._push.events[0 /* All */] !== undefined) {
            ...
            if (model._push.events[2 /* VideoStates */] !== undefined || model._push.events[0 /* All */] !== undefined) {
    ...
    PushMFC.prototype.modelRankPusher = function (model, before, after) {
        if ((model._push.events[3 /* Rank */] !== undefined || model._push.events[0 /* All */] !== undefined) && before !== after && (before !== undefined || after !== 0)) {
    ...
    PushMFC.prototype.modelTopicPusher = function (model, before, after) {
        if ((model._push.events[4 /* Topic */] !== undefined || model._push.events[0 /* All */] !== undefined) && before !== after && after !== undefined && after !== null && after !== "") {
